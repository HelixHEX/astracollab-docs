...
```json
{
  ...
  "data": {
    ...
    "parts": [
      {
        "partNumber": 1,
        "uploadUrl": "https://storage.astracollab.com/upload/part1?token=...",
        "size": 52428800
      },
      {
        "partNumber": 2,
        "uploadUrl": "https://storage.astracollab.com/upload/part2?token=...",
        "size": 52428800
      }
    ],
    "totalParts": 20,
...
```bash
curl -X PUT "https://storage.astracollab.com/upload/part1?token=..." \
