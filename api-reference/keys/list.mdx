...
```bash
curl -X GET "https://api.astracollab.com/v1/keys?page=1&limit=20" \
...
```bash
# Active keys only
curl -X GET "https://api.astracollab.com/v1/keys?status=active"

# Expired keys
curl -X GET "https://api.astracollab.com/v1/keys?status=expired"

# Revoked keys
curl -X GET "https://api.astracollab.com/v1/keys?status=revoked"
```
...
```bash
curl -X GET "https://api.astracollab.com/v1/keys?search=production" \
  -H "Authorization: Bearer your-api-key-here"
```
...
curl -X GET "https://api.astracollab.com/v1/keys?sortBy=name&sortOrder=asc"

# Sort by creation date (newest first)
curl -X GET "https://api.astracollab.com/v1/keys?sortBy=createdAt&sortOrder=desc"

# Sort by last usage (most recently used first)
curl -X GET "https://api.astracollab.com/v1/keys?sortBy=lastUsedAt&sortOrder=desc"
```
...
```bash Curl
curl -X GET "https://api.astracollab.com/v1/keys" \
  -H "Authorization: Bearer your-api-key-here"
```
