...
- **Additional Storage**: $0.03/GB/month
- **Features**: Basic video tools, API access, 10,000 requests/hour

### Studio Plan
- **Price**: $25/user/month
- **Included Storage**: 250GB per user
- **Additional Storage**: $0.025/GB/month
- **Features**: Advanced editing, priority support, 50,000 requests/hour

### Production Plan
- **Price**: $45/user/month
- **Included Storage**: 500GB per user
- **Additional Storage**: $0.02/GB/month
- **Features**: Full pipeline, dedicated support, 100,000 requests/hour
...
- **Support**: Email us at billing@astracollab.com
